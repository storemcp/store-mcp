...
<div class="wrap store-mcp-wrap">
	...
	<div class="store-mcp-connect-grid">
		...
		<div class="store-mcp-connect-card" data-client="chatgpt">
			...
			<ol class="store-mcp-steps" hidden>
				<li><?php esc_html_e( 'In ChatGPT → Settings → Apps & Connectors → Advanced Settings → enable Developer Mode.', 'store-mcp' ); ?></li>
				<li><?php esc_html_e( 'Go to Connectors → click Create. Name it StoreMCP and paste the URL above as the MCP Server URL.', 'store-mcp' ); ?></li>
